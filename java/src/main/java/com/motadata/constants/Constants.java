...
public class Constants
{
    ...
    public static final int RESOURCE_NOT_PRESENT = 404;

    public static final String MESSAGE = "message";

    public static final String RESULT = "result";

    public static final String HOST_PORT = "object.port";

    public static final String SSH_TIMEOUT = "ssh.timeout.duration";

    public static final String PROCESS_TIMEOUT = "process.timeout";

    public static final String POLL_TIME = "poll.time";

    public static final String HOST_IP = "object.ip";
